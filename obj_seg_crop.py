...
SEG_DIR = os.path.join(ROOT_DIR, "randCOCOSegCrop")
...
IMAGE_DIR = os.path.abspath("C:/Users/hllun/ML_data/foodTray123119") #Need to change it down at collection creation at bottom
